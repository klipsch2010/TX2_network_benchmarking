...
def main(args):
    ...
    f=open("results/ssd_result.txt", "a+")
    ...
    # save file name to first element
    f.write('%s, ' % args.image_file)
    
    # Loop through the detected objects and report the results
    for item in result:
    ...
    f.write('\n')
    # condition output image name and create output image
    output_name = args.image_file
    output_name = output_name.replace("/", "_")
    output_name = 'detect_result_' + output_name
    output_name = 'results/images/' + output_name
    print(output_name)
